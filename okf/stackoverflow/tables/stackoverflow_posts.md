...
description: A legacy table containing all posts from Stack Overflow. This table is deprecated; use `posts_answers`,
  `posts_questions`, or other `posts_*` tables instead.
tags:
- Stack Overflow, posts, legacy, deprecated
...
sources:
- id: compiler-input
  resource: source://stackoverflow/tables/stackoverflow_posts.md
  title: 'Compiler input: tables/stackoverflow_posts.md'
  last_modified: '2026-07-20T03:27:52Z'
  sha256: c5e8b58c624ffc28958db4abd96965a66a45928a0c8837569323121422147306
