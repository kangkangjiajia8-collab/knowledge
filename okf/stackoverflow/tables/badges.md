...
title: Badges
description: This table contains information about badges awarded to users on the Stack Overflow platform,
  including details about the badge name, class, and whether it is tag-based.
tags:
- stackoverflow
- badges
- users
