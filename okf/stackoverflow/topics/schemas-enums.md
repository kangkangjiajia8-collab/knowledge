---
type: Domain Topic
title: Schemas and enums
description: Table structures and stable ID mappings.
tags:
...
- id: concept-4
  resource: ../references/close_reason_types.md
  title: Close Reason Types
- id: concept-5
  resource: ../references/flag_types.md
  title: Flag Types
- id: concept-6
  resource: ../references/link_types.md
  title: Link Types
- id: concept-7
...
- id: concept-10
  resource: ../references/post_notice_class_ids.md
  title: Post Notice Class IDs
- id: concept-11
  resource: ../references/post_notice_duration_ids.md
  title: Post Notice Duration IDs
- id: concept-12
  resource: ../references/post_notice_type_definitions.md
  title: Post Notice Type Definitions
- id: concept-13
  resource: ../references/post_notice_types.md
  title: Post Notice Types
- id: concept-14
  resource: ../references/post_notices.md
  title: Post Notices
- id: concept-15
  resource: ../references/post_type_ids.md
  title: Post Type IDs
- id: concept-16
  resource: ../references/related_questions.md
  title: Related Questions
- id: concept-17
  resource: ../references/review_rejection_reasons.md
  title: Review Rejection Reasons
- id: concept-18
  resource: ../references/review_task_result_types.md
  title: Review Task Result Types
- id: concept-19
  resource: ../references/review_task_results.md
  title: Review Task Results
- id: concept-20
  resource: ../references/review_task_states.md
  title: Review Task States
- id: concept-21
...
- id: concept-22
  ...
  title: Review Tasks
- id: concept-23
  resource: ../references/sede_databases.md
  title: SEDE Databases
- id: concept-24
  resource: ../references/sede_databases_markdown.md
  title: SEDE Databases Markdown
- id: concept-25
  resource: ../references/sede_ineachdb.md
  title: SEDE In Each DB Stored Procedure
- id: concept-26
  resource: ../references/sede_sites.md
  title: SEDE Sites
- id: concept-27
  resource: ../references/sede_tables.md
  title: SEDE Tables
- id: concept-28
...
Table structures and stable ID mappings.
...
* [Close Reason Types](../references/close_reason_types.md) — Enumerated types for reasons why a post might be closed on Stack Exchange.
* [Flag Types](../references/flag_types.md) — Enumerated types for flags related to post moderation on Stack Exchange.
* [Link Types](../references/link_types.md) — Enumerated types for links between posts on Stack Exchange.
...
* [Post Notice Class IDs](../references/post_notice_class_ids.md) — Enumerated class identifiers for different types of post notices.
* [Post Notice Duration IDs](../references/post_notice_duration_ids.md) — Enumerated duration identifiers for post notices.
* [Post Notice Type Definitions](../references/post_notice_type_definitions.md) — Defines the structure and properties of different types of post notices.
* [Post Notice Types](../references/post_notice_types.md) — Enumerated types for notices that can be applied to posts on Stack Exchange.
...
* [Post Type IDs](../references/post_type_ids.md) — Enumerated IDs for different types of posts on Stack Exchange.
...
* [Review Rejection Reasons](../references/review_rejection_reasons.md) — Defines canned rejection reasons for suggested edits.
* [Review Task Result Types](../references/review_task_result_types.md) — Enumerated types for the outcomes of review tasks on Stack Exchange.
* [Review Task Results](../references/review_task_results.md) — Stores the outcomes and details of completed review tasks.
* [Review Task States](../references/review_task_states.md) — Enumerated states for review tasks on Stack Exchange.
...
* [SEDE Databases](../references/sede_databases.md) — Details the structure of the internal SEDE database metadata table.
* [SEDE Databases Markdown](../references/sede_databases_markdown.md) — Describes a SEDE internal table containing markdown content for database information.
* [SEDE In Each DB Stored Procedure](../references/sede_ineachdb.md) — Describes the SEDE internal stored procedure for running SQL commands across multiple databases.
* [SEDE Sites](../references/sede_sites.md) — Details the structure of the internal SEDE sites metadata table.
* [SEDE Tables](../references/sede_tables.md) — Details the structure of the internal SEDE tables metadata table.
...
* [Post Links](../tables/post_links.md) — Contains information about links between posts on Stack Overflow, including the type of link and the posts involved.
...
* [Tags](../tables/tags.md) — A table containing information about tags used on Stack Overflow, including tag names, counts, and references to their excerpt and wiki posts, along with moderation settings.
